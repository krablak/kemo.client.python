...
QUnit.test("Run encryption function with wrong or missing arguments.", function(assert) {
  ...
  assert.ok(kemo.encryption.encrypt(null, null, null), "Encryption with null args should not fail.");
